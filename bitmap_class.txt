...
public:
	...
	// returns int with the Red color value for point (x, y)
	int cBitmap::GetRedColor(int x, int y);

	// returns int with the Green color value for point (x, y)
	int cBitmap::GetGreenColor(int x, int y);

	// returns int with the Blue color value for point (x, y)
	int cBitmap::GetBlueColor(int x, int y);

	// returns int with the Alpha value for point (x, y)
	int cBitmap::GetAlpha(int x, int y);
